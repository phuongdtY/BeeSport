...
function ModalDiaChi({ openModal,closeModal }) {
    ...
    },
    {
      ...
      render: (id) => {
        const actionItems: MenuProps["items"] = [
          ...
          {
            icon: <EditOutlined />,
            label: <Button style={{margin:0,padding:0}} type="link" onClick={()=>handOnClickUpdateDc(id)} >
            Chỉnh sửa
        </Button>,
            key: "1",
          },
  ...
  return (
    <>
    <Modal style={{ top: 20 }}
      width={1200} open={openModal} onCancel={closeModal}>
      ...
      <ModalUpdateDCKhachHang id={id} openModal={modalUpdateDiaChi} closeModal={()=>setModalUpdateDiaChi(false)} />
      </Modal>
    </>
  );
};
